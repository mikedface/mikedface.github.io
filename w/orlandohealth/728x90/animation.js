...
startAnimation = function() {
    ...
    .set("#container_dc",{opacity:1})
        ...
        .from("#people1",.85,{x:-620,ease:Sine.easeOut},"in2")
       .from("#text2", .5,{opacity:0},"in2+=.35")
        .from("#icon1", .5,{opacity:0, x:-200},"in2")
    .add("out2","+=2")
        .to("#people1",.35,{x:400,opacity:0},"out2")
        .to("#text2,#icon1", .25,{opacity:0},"out2")
    
    .from("#people2",.85,{x:-450,ease:Sine.easeOut},"in3")
       .from("#text3", .5,{opacity:0},"in3+=.25")
        .from("#icon2", .5,{ease: Bounce.easeOut, y: -200 },"in3+=.35")
    .add("out3","+=2")
        .to("#people2",.35,{x:400,opacity:0},"out3")
        .to("#text3,#icon2", .25,{opacity:0},"out3")

     .from("#people3",.85,{x:-490,ease:Sine.easeOut},"in4")
       .from("#text4", .5,{opacity:0},"in4+=.35")
        .from("#icon3", .5,{ease: Bounce.easeOut, scale:0 },"in4")
    .add("out4","+=2")
        .to("#people3",.35,{x:400,opacity:0},"out4")
        .to("#text4,#icon3", .25,{opacity:0},"out4")

         .from("#people4",.85,{x:-470,ease:Sine.easeOut},"in5")
       .from("#text5", .5,{opacity:0},"in5+=.34")
        .from("#icon4", .5,{x:-100},"in5+=.5")
